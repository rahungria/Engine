...
namespace raphen::events
{
	...
	unsigned int MouseEvent::GetCategoryFlags() const { return EventCategoryMouse | EventCategoryInput; }
	...
	MouseScrolledEvent::MouseScrolledEvent(double x, double y, double _x_offset, double _y_offset) :
...
// --------------- MOUSE BUTTON EVENT -----------------------
	...
	inline unsigned int MouseButtonEvent::GetMouseButton() const { return m_mouse_button; }

	unsigned int MouseButtonEvent::GetCategoryFlags() const { return EventCategoryMouse | EventCategoryInput | EventCategoryMouseButton; }

	// --------------- MOUSE BUTTON DOWN EVENT -----------------------

	MouseButtonDownEvent::MouseButtonDownEvent(double x, double y, unsigned int button) :
		MouseButtonEvent(x, y, button) {}

	EventType MouseButtonDownEvent::GetStaticType() { return EventType::MouseButtonDown; }
	EventType MouseButtonDownEvent::GetEventType() const { return GetStaticType(); }
	const char* MouseButtonDownEvent::GetName() const { return "MouseButtonDownEvent"; }
	...
	EventType MouseButtonUpEvent::GetStaticType() { return EventType::MouseButtonUp; }
