...
namespace raphen::events
{
	...
	unsigned int AppTickEvent::GetCategoryFlags() const { return EventCategoryApplication; }
	...
	unsigned int AppUpdateEvent::GetCategoryFlags() const { return EventCategoryApplication; }
	...
	unsigned int AppRenderEvent::GetCategoryFlags() const { return EventCategoryApplication; }
}